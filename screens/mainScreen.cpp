...
MainScreen::MainScreen(SDL_Renderer *renderer, SDL_Texture *asst)
{
    gRenderer = renderer;
    assets = asst;
    newGame = Button({1067, 487, 225, 88}, {1480, 609, 225, 72}, {76, 86, 225, 88}, {76, 102, 225, 72});
    instructions = Button({1031, 594, 297, 88}, {1453, 120, 297, 72}, {40, 223, 297, 88}, {40, 239, 297, 72});
    options = Button({1067, 374, 225, 88}, {1490, 701, 225, 72}, {76, 360, 225, 88}, {76, 376, 225, 72});
    quit = Button({1052, 141, 225, 88}, {1479, 308, 225, 72}, {76, 497, 225, 88}, {76, 513, 225, 72});
    state = 0;
}
